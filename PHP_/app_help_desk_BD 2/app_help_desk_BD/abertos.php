...
$row = $res->fetch_assoc(); 
$totalAbertos = $row['Total'];

// Consulta para obter os detalhes dos chamados abertos
...
<head>
  <meta charset="utf-8" />
  <title>App Help Desk - Chamados Abertos</title>
  ...
  <div class="container admin-table-container"> <br>
    <?php
        if($qtd > 0){
            ...
            print "<th class='status-header status-aberto-bg' colspan='2'> Status Aberto </th>"; print "<th colspan='3' class='total-chamados-header'> Total de Chamados Abertos: $totalAbertos</th>"; print "</tr>";
            print "<tr>";
            ...
            print "</div>";
             ...
             print "<div class='no-chamados-message'>Nenhum chamado 'Aberto' encontrado.</div>";
        }
    ?>
  </div>
</body>
